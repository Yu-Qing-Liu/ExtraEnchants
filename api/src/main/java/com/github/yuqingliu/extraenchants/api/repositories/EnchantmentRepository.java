...
public interface EnchantmentRepository {
    ...
    public enum EnchantID {
        ...
        SILK_TOUCH, SMITE, SOUL_SPEED, SWEEPING_EDGE, SWIFT_SNEAK, THORNS, UNBREAKING, VANISHING_CURSE, DENSITY, WIND_BURST,
        // Custom enchants ids
        ...
        public Rarity rarity() {
            return switch (this) {
                ...
                case AQUA_INFINITY, BANE_OF_ARTHROPODS, BLAST_PROTECTION, CHANNELING, DEPTH_STRIDER, EFFICIENCY, FEATHER_FALLING,
                     ...
                     SILK_TOUCH, SMITE, SOUL_SPEED, SWEEPING_EDGE, SWIFT_SNEAK, THORNS, UNBREAKING, DENSITY, WIND_BURST -> Rarity.UNCOMMON;
                // RARE RARITY
