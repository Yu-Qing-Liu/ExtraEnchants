...
public class QuickCharge extends VanillaEnchantment {
    public QuickCharge(ManagerRepository managerRepository, EnchantmentRepository enchantmentRepository, TextColor nameColor, TextColor descriptionColor) {
        super(
            managerRepository, enchantmentRepository,
            EnchantID.QUICK_CHARGE,
